...
const Levis = () => {
    ...
    const images = [
        'https://i.ibb.co/WBdXdrK/3.png',
        'https://i.ibb.co/QkFyWRr/2-1.jpg',
        'https://i.ibb.co/XpWdyGc/1-1.jpg',
        ...
        <div>
            <div className="">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-5 py-7'>
                    {
                        brandProduct.filter(check => check.brand == 'Levi\'s').map(brand => <div key={brand._id}>
