...
const HnM = () => {
    ...
    const images = [
        'https://i.ibb.co/Wk7Rdwp/1.jpg',
        'https://i.ibb.co/YDJcpLq/2.png',
        'https://i.ibb.co/Njpx54C/hn1.png',
        ...
        <div>
            <div className="">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-5 py-7'>
                    {
                        brandProduct.filter(check => check.brand == 'H&M').map(brand => <div key={brand._id}>
