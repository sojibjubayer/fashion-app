            ...
            <div className="min-h-screen">
                ...
                <div className="mt-2">
                    ...
                    <div className="flex gap-16 justify-center -mt-4 md:-mt-5">
                        <button onClick={prevSlide}><FaArrowAltCircleLeft className="bg-white rounded-full text-[#438A92] text-3xl md:text-4xl"></FaArrowAltCircleLeft></button>
                        <button onClick={nextSlide}><FaArrowAltCircleRight className="bg-white rounded-full text-[#438A92] text-3xl md:text-4xl"></FaArrowAltCircleRight></button>
                    </div>
                </div>
