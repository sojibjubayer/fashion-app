...
const Nike = () => {
    ...
    const images = [
        'https://i.ibb.co/Q9M2M3t/1.jpg',
        'https://i.ibb.co/mNzmn89/3.jpg',
        'https://i.ibb.co/s2PVyD5/1-1.png',
        ...
        <div>
            <div className="">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-5 py-7'>
                    {
                        brandProduct.filter(check => check.brand == 'Nike').map(brand => <div key={brand._id}>
